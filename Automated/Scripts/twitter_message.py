    ...
    def generate_final_twitter_messages(self, additional_queries):
        ...
        for message in initial_messages:
            ...
            additional_prompt = (
                ...
                f"Focus on Trends and Insights:\n"
                f"3. Highlight meaningful trends or patterns across time or categories, rather than focusing solely on isolated outliers.\n"
                f"4. Provide aggregate comparisons or summaries when possible (e.g., 'over the past week,' 'comparing Q1 to Q2,' 'cumulative totals').\n"
                f"5. Ensure the insights form a cohesive narrative rather than a disjointed list of metrics. Each insight should connect logically to the broader story.\n\n"
                f"Maintain a Professional and Accessible Tone:\n"
                f"6. Use concise and direct language suitable for both newcomers and experts in the field.\n"
                f"7. Avoid emojis, hashtags, or unsupported speculation.\n"
                f"8. When suggesting reasons for trends, use moderate wording like 'could indicate,' 'may reflect,' or 'suggests.'\n\n"
                f"Formatting & Style:\n"
                f"9. Present the insight as part of a numbered thread. For this message, format it as: {counter}/.\n"
                f"10. Deliver one main insight with relevant numbers or comparisons, keeping the message under 280 characters for a tweet-friendly format.\n\n"
            )
            counter += 1 
